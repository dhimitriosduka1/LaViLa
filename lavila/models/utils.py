...
def remap_keys(clip_state_dict, transformer_layers=12):
    ...
    for layer in range(transformer_layers):
        key_mapping[f"transformer.resblocks.{layer}.attn.in_proj_weight"] = (
            f"blocks.{layer}.attn.qkv.weight"
        )
        key_mapping[f"transformer.resblocks.{layer}.attn.in_proj_bias"] = (
            f"blocks.{layer}.attn.qkv.bias"
        )
        key_mapping[f"transformer.resblocks.{layer}.attn.out_proj.weight"] = (
            f"blocks.{layer}.attn.proj.weight"
        )
        key_mapping[f"transformer.resblocks.{layer}.attn.out_proj.bias"] = (
            f"blocks.{layer}.attn.proj.bias"
        )
        key_mapping[f"transformer.resblocks.{layer}.ln_1.weight"] = (
            f"blocks.{layer}.norm1.weight"
        )
        key_mapping[f"transformer.resblocks.{layer}.ln_1.bias"] = (
            f"blocks.{layer}.norm1.bias"
        )
        key_mapping[f"transformer.resblocks.{layer}.mlp.c_fc.weight"] = (
            f"blocks.{layer}.mlp.fc1.weight"
        )
        key_mapping[f"transformer.resblocks.{layer}.mlp.c_fc.bias"] = (
            f"blocks.{layer}.mlp.fc1.bias"
        )
        key_mapping[f"transformer.resblocks.{layer}.mlp.c_proj.weight"] = (
            f"blocks.{layer}.mlp.fc2.weight"
        )
        key_mapping[f"transformer.resblocks.{layer}.mlp.c_proj.bias"] = (
            f"blocks.{layer}.mlp.fc2.bias"
        )
        key_mapping[f"transformer.resblocks.{layer}.ln_2.weight"] = (
            f"blocks.{layer}.norm2.weight"
        )
        key_mapping[f"transformer.resblocks.{layer}.ln_2.bias"] = (
